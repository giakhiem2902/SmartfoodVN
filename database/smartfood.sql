...
--
-- Host: localhost:3306
-- Generation Time: Apr 09, 2026 at 06:31 PM
...
--
-- Table structure for table `store_registrations`
--
...
ALTER TABLE `categories`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_category` (`store_id`,`name`),
...
--
-- Indexes for table `store_registrations`
--
...
--
-- AUTO_INCREMENT for table `store_registrations`
--
ALTER TABLE `store_registrations`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `driver_location_history`
  ADD CONSTRAINT `driver_location_history_ibfk_1` FOREIGN KEY (`driver_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `driver_location_history_ibfk_2` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `foods`
  ...
  ADD CONSTRAINT `foods_ibfk_2` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `orders`
  ...
  ADD CONSTRAINT `orders_ibfk_3` FOREIGN KEY (`driver_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `order_items`
  ...
  ADD CONSTRAINT `order_items_ibfk_2` FOREIGN KEY (`food_id`) REFERENCES `foods` (`id`) ON DELETE RESTRICT;

--
-- Constraints for table `promotions`
--
ALTER TABLE `promotions`
  ADD CONSTRAINT `promotions_ibfk_1` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `ratings`
  ...
  ADD CONSTRAINT `ratings_ibfk_3` FOREIGN KEY (`driver_id`) REFERENCES `users` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `ratings_ibfk_4` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `store_registrations`
--
ALTER TABLE `store_registrations`
  ADD CONSTRAINT `store_registrations_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
